...
<body>
    ...
    <!-- Libs JS -->
    <script src="{{ asset("_tabler/libs/apexcharts/dist/apexcharts.min.js") }}" defer></script>
    <script src="{{ asset("_tabler/dist/libs/jsvectormap/dist/js/jsvectormap.min.js") }}" defer></script>
    <script src="{{ asset("_tabler/dist/libs/jsvectormap/dist/js/jsvectormap.min.js") }}" defer></script>
    <script src="{{ asset("_tabler/dist/libs/jsvectormap/dist/maps/world-merc.js") }}" defer></script>
    <!-- Tabler Core -->
